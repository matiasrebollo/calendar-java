...
public class FrecuenciaTest{
    ...
    public void frecuenciaCero() {
        ...
        var f  = new FrecuenciaCero(fecha);

        assertEquals(fecha, f.calcularFechaFin());
    }
    @Test
    public void frecuenciaDiaria() {
        ...
        int intervalo = 1;
        int ocurrencias = 5;
        var f  = new FrecuenciaDiaria(fecha, intervalo,ocurrencias);
    ...
    public void frecuenciaSemanalCadaUnaSemana() {
        ...
        int intervalo = 1;
        int ocurrencias = 3;
        var f  = new FrecuenciaSemanal(fecha, intervalo,ocurrencias);
    ...
    public void frecuenciaMensualCadaUnMes() {
        ...
        int intervalo = 1;
        int ocurrencias = 3;
        var f  = new FrecuenciaMensual(fecha, intervalo,ocurrencias, FrecuenciaMensual.Tipo.MISMONUMERO);
    ...
    public void frecuenciaMensual1erLunes() {
        ...
        int intervalo = 1;
        int ocurrencias = 4;
        var f  = new FrecuenciaMensual(fecha, intervalo, ocurrencias, FrecuenciaMensual.Tipo.MISMODIA);
    ...
    public void frecuenciaCadaUnAnio() {
        ...
        int intervalo = 1;
        int ocurrencias = 3;
        var f  = new FrecuenciaAnual(fecha, intervalo,ocurrencias);
    ...
    public void fechaCorrespondeAFrecuenciaDiaria() {
        ...
        int intervalo = 1;
        var f = new FrecuenciaDiaria(fecha, intervalo, fechaFin);
    ...
    public void fechaCorrespondeAFrecuenciaSemanal() {
        ...
        var f = new FrecuenciaSemanal(fecha, intervalo, fechaFin);
    ...
    public void fechaCorrespondeAFrecuenciaSemanalDomingoYViernes() {
        ...
        int intervalo = 1;
        var f  = new FrecuenciaSemanal(fecha, intervalo, null);
    ...
    public void fechaCorrespondeAFrecuenciaCada3Meses() {
        ...
        var f = new FrecuenciaMensual(fecha, intervalo, null, FrecuenciaMensual.Tipo.MISMONUMERO);
    ...
    public void fechaCorrespondeAFrecuenciaCada2MesesMismoDia() {
        ...
        var f = new FrecuenciaMensual(fecha, intervalo, null, FrecuenciaMensual.Tipo.MISMODIA);
    ...
    public void fechaCorrespondeAFrecuenciaCada2Anios() {
        ...
        var f = new FrecuenciaAnual(fecha, intervalo, null);
    ...
    public void obtenerProximaFechaSemanal1() {
        ...
        var fechaDevuelta = f.obtenerFechaProxima();
    ...
    public void obtenerProximaFechaMensual1() {
        ...
        var f = new FrecuenciaMensual(fecha, intervalo, null, FrecuenciaMensual.Tipo.MISMODIA);
        f.setTipoFrecuenciaMensual(FrecuenciaMensual.Tipo.MISMONUMERO);
        var fechaDevuelta = f.obtenerFechaProxima();
