...
public class prueba extends Application {
    ...
    private void mostrarEventosEnLaInterfazSemana(VBox columnaDia, DayOfWeek diaSemana){
        ...
        labelEvento.setMaxWidth(columnaDia.getWidth());
        ...
        if (evento1.getFechaInicio().getDayOfWeek().equals(diaSemana)) {
            ...
            //columnaDia.setMaxWidth(Region.USE_PREF_SIZE);
        }
    }
    /**
     *
    ...
    private ChoiceBox choiceBoxDeFrecuencia(VBox caja, Label labelIntervalo){
    ...
    private CheckBox crearCheckBox(VBox caja) {
    ...
    private HBox crearBotonesVentanaTarea(Stage ventana, TextField tituloField, TextArea descripcionField,
        ...
        botonAceptar.setOnAction(actionEvent -> {
            ...
            if (fechaPicker.getValue() != null) {
                ...
                String descrpcion = descripcionField.getText();
                ...
                System.out.println("Descripcion: " + descrpcion);
    ...
    private Node contenidoVentanaEmergenteTarea(Stage ventana) {
        var tituloField = new TextField();
        ...
        var hbox = new HBox(new Label(" Hora "), horaSpinner, new Label(" Minutos "), minutosSpinner);
        hbox.setAlignment(Pos.CENTER_LEFT);
        var horarioVbox = new VBox(new Label("Horario"), hbox);

        var intervaloSpinner = new Spinner<>(1,31,0);  intervaloSpinner.setPrefWidth(70);
        var labelIntervalo = new Label("Intervalo", intervaloSpinner);

        var formulario = new VBox(5);//5px de espacio entre bloques

        var frecuenciaChoice = choiceBoxDeFrecuencia(formulario, labelIntervalo);
        var todoEldiaBox = crearCheckBox(formulario);

        formulario.getChildren().addAll(
                                    new Label("Titulo: "), tituloField,
                                    new Label("Descripcion:"),descripcionField,
                                    new Label("Fecha: "), fechaField, horarioVbox,
        ...
        var botones = crearBotonesVentanaTarea(ventana, tituloField,descripcionField,fechaField,horaSpinner,
                                               minutosSpinner, todoEldiaBox,frecuenciaChoice,intervaloSpinner);
    ...
    private void abrirVentanaEmergente(){
        ...
        var contenido = (BorderPane) contenidoVentanaEmergenteTarea(ventana);
